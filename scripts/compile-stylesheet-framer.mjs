...
//
// Writes framer/happen.css (the sheet) and framer/happen-css.mjs (the same sheet
// as a template string plus the injector). Framer components import the second
// one: Site Settings → Custom Code does not run on the Framer canvas, so a sheet
// pasted there leaves components unstyled while you are designing.
...
const OUT_JS = path.join(OUT_DIR, "happen-css.mjs");
