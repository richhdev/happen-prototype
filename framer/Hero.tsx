            ...
            >
                ...
                <div className="heroCopyGroup">
                    <TextXXLarge className="heroCopy">
                        We&apos;re a Melbourne-based events agency built on over
                        10 years of rolling up our sleeves and doing the work.
                        We move fast, think creatively and deliver with
                        precision.
                    </TextXXLarge>
                    <div className="heroButtonGroup">
                        <ButtonLarge href="#a-contact">
                            Let&apos;s talk
                        </ButtonLarge>
